...
SELECT * FROM Usuario;
-- usuario
INSERT INTO Usuario(idUsuario,nombre,apellido,email,telefono,contrasena,checkTyC, `admin` , imgUsuario)
VALUES
(null, 'Brandy', 'Medina','medina@gmail.com','3358796542','Password_1',1,1,'brandy.jpg'),
(null, 'Jade', 'Ullola','ullola@gmail.com','3325469875','Password_2',1,1,'jade.jpg'),
(null, 'Abigail', 'Ramírez','ramirez@gmail.com','3387564123','Password_3',1,1,'abigail.jpg'),
(null, 'Isabel', 'Romero','romero@gmail.com','3398325469','Password_4',1,1,'isabel.jpg'),
(null, 'Marian', 'Tejeda','tejeda@gmail.com','3354870213','Password_5',1,1,'marian.jpg'),
(null, 'Mariana', 'González','gonzalez@gmail.com','3325146987','Password_6',1,1,'mariana.jpg'),
(null, 'Maritere', 'Montiel','montiel@gmail.com','3325469872','Password_7',1,1,'maritere.jpg'),
(null, 'Miriam', 'Vega','vega@gmail.com','3303259710','Password_8',1,1,'miriam.jpg'),
(null,'Miguel', 'R.', 'miguelr@example.com', '5512345678', 'Password_9', 1, 0, 'miguel.jpg'),
(null,'Ana', 'L.', 'anal@example.com', '5523456789', 'Password_10', 1, 0, 'ana.jpg'),
(null,'Roberto', 'G.', 'robertog@example.com', '5534567890', 'Password_11', 1, 0, 'roberto.jpg'),
(null,'Sofía', 'M.', 'sofiam@example.com', '5545678901', 'Password_12', 1, 0, 'sofia.jpg'),
(null,'Carlos', 'P.', 'carlosp@example.com', '5556789012', 'Password_13', 1, 0, 'carlos.jpg');
SELECT * FROM Usuario;
-- tours
SELECT * FROM Tours;
INSERT  INTO Tours 
...
SELECT * FROM Usuario_has_Tours;
-- Usuario has tour
INSERT  INTO Usuario_has_Tours(id,fk_idUsuario,fk_idTours)
VALUES
(null,9,2),
(null,10,3),
(null,11,5),
...
-- Experiencias
INSERT INTO Experiencia (idExperiencia, comentario, calificacion, fecha, fk_idTours, fk_idUsuario)
VALUES
